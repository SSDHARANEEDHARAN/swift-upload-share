        ...
        messages: [
          {
            ...
            content: [
              {
                type: 'text',
                text: 'Describe this image and suggest how it could be animated as a short video loop. Be specific about motion, camera movement, and effects that would work well.'
              },
              {
                type: 'image_url',
                image_url: { url: image }
