            ...
            content: [
              {
                type: "text",
                text:
                  "Analyze this image for 3D model generation. Describe the object, its dimensions, materials, textures, and how it would look from all angles. Provide a detailed description suitable for 3D modeling.",
              },
              {
                type: "image_url",
